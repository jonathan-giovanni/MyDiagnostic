...
public class NearbyPlaces extends AbstractPlaces {
    ...
    private NearbyPlaces(Builder builder) {

        super(builder.listener);
        setKey("AIzaSyCPNL19Statnfac_LR6sE9Hf42b77Uk_c0");
    ...
    public static final class Builder {
        ...
        public NearbyPlaces build() {
            return new NearbyPlaces(this);
        }
    }
}
